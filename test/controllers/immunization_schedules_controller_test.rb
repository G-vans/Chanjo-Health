...
class ImmunizationSchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create immunization_schedule" do
    assert_difference("ImmunizationSchedule.count") do
      post immunization_schedules_url, params: { immunization_schedule: { child_id: @immunization_schedule.child_id, medic_id: @immunization_schedule.medic_id, scheduled_date: @immunization_schedule.scheduled_date, vaxx_name: @immunization_schedule.vaxx_name } }
    end
  ...
  test "should update immunization_schedule" do
    patch immunization_schedule_url(@immunization_schedule), params: { immunization_schedule: { child_id: @immunization_schedule.child_id, medic_id: @immunization_schedule.medic_id, scheduled_date: @immunization_schedule.scheduled_date, vaxx_name: @immunization_schedule.vaxx_name } }
