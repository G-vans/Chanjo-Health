...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference("Follow.count") do
      post follows_url, params: { follow: { name: @follow.name, phone_number: @follow.phone_number } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { name: @follow.name, phone_number: @follow.phone_number } }
